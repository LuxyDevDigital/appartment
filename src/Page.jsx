    ...
    <div className="Landing">
      ...
      <section className="hero">
        ...
        <div className="hero-overlay">
          <div className="hero-content">
            ...
            <p className="hero-description">
              Découvrez nos propriétés exclusives et trouvez votre maison de rêve.
              <br />
        ...
        <div className="slider">
          <div className={`slide_item ${activeSlide === 0 ? "active_item" : ""}`}></div>
          <div className={`slide_item ${activeSlide === 1 ? "active_item" : ""}`}></div>
          <div className={`slide_item ${activeSlide === 2 ? "active_item" : ""}`}></div>
        </div>
      </section>

      {/* Services Section */}
      <section className="services">
        <h2 className="section-title">EVERYTHING SHOULD BE THIS EASY.</h2>
      ...
      <section className="projects">
        ...
        <div className="projects-list">
          <Card
            ...
            description={"Une villa moderne avec vue sur l'océan, offrant luxe et confort dans un cadre exceptionnel."}
      ...
      <section className="featured-villa">
        ...
        <div className="villa-details">
          ...
          <p className="villa-description">
            Plongez dans un havre de paix au cœur de la nature. Villa Oasis vous offre une expérience unique alliant luxe et sérénité, conçue pour répondre à vos besoins les plus exigeants.
            <br />
            Des terrasses ouvertes baignées de lumière et de verdure, jusqu'aux espaces intérieurs raffinés, cette villa incarne l'art de vivre marocain moderne.
            <br />
            Profitez d’installations haut de gamme, d’un jardin spacieux et d’une piscine privée pour des moments inoubliables en famille ou entre amis.
          </p>
          <div className="villa-features">
            <div className="feature-item"><Bath className="feature-icon" /><span className="feature-number">2</span></div>
            <div className="feature-item"><CarFront className="feature-icon" /><span className="feature-number">2</span></div>
            <div className="feature-item"><Dumbbell className="feature-icon" /><span className="feature-number">1</span></div>
            <div className="feature-item"><WavesLadder className="feature-icon" /><span className="feature-number">2</span></div>
            <div className="feature-item"><BedDouble className="feature-icon" /><span className="feature-number">7</span></div>
          </div>
        </div>
      </section>
      ...
      <section className="company">
        <h2 className="section-title">WE ARE A GLOBAL, BOUTIQUE <br />REAL ESTATE BROKERAGE</h2>
        <div className="company-container">
          <div className="company-content">
            <div className="company-text">
              <h3 className="company-section-title">THE TRANSFER OF REAL ESTATE</h3>
              <p className="company-description">
                Notre équipe d'experts immobiliers s'engage à vous offrir un service personnalisé et professionnel. Grâce à notre réseau et notre expertise, nous vous accompagnons à chaque étape.
              </p>
            </div>
          ...
          <img src="/appartment/company.jpg" alt="Real estate professionals" className="company-image" />
        </div>
      </section>
      ...
      <section className="contact">
        ...
        <div className="contact-container">
          <img src="/appartment/contact_img.jpg" alt="Contact villa" className="contact-image" />
          <div className="contact-form">
            <h3 className="contact-form-title">Book appartement</h3>
            <p className="contact-form-description">
              Un nouveau style d'appartement avec vue sur la mer. Réservez maintenant pour découvrir le luxe.
            </p>
            <form className="form">
              <div className="form-row">
                <Input id="fname" placeholder="first name" label={"First Name"} />
                <Input id="lname" placeholder="last name" label={"Last Name"} />
              </div>
              <div className="form-row">
                <Input id="email" placeholder="Email" label={"Email"} type="email" />
                <Input id="phone" placeholder="Téléphone" label={"Téléphone"} />
              </div>
              <div className="form-row select-row">
                <label htmlFor={"service"} className="input-label">Services</label>
      ...
      <footer className="footer">
        <div className="footer-container">
          <div className="footer-grid">
            <div className="connect-section">
              <div className="footer-brand">
                ...
                <span className="logo_title" style={{ color: "#fff" }}>IMMOBILIER</span>
              </div>
            ...
            <div>
              ...
              <ul className="footer-links">
                <li><a href="#">Vente de propriétés</a></li>
          ...
          <div className="footer-bottom">
            <p>&copy;2025 ARR, All right reserved.</p>
            <div>
              <p>Privacy Policy</p>
